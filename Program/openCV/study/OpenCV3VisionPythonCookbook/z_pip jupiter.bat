...
scripts\pip install imutils
scripts\pip install scikit-image
scripts\pip install sympy
rem scripts\pip install opencv-python
scripts\pip install opencv-contrib-python
scripts\pip install git+git://github.com/mkrphys/ipython-tikzmagic.git --force-reinstall
@echo off
